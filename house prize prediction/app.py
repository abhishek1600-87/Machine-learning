...
def predict_house_price(input_features): 
    with open(r'C:\Users\IICET 22\Desktop\abhishek\project store\house prize prediction\best_model.pkl', 'rb') as model_file:  # Load trained model 
        model = pickle.load(model_file) 
    with open(r'C:\Users\IICET 22\Desktop\abhishek\project store\house prize prediction\scaler.pkl', 'rb') as scaler_file:  # Load feature scaler 
